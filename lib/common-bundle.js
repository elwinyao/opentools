...
App.CONFIG = {
  ...
  REALTIME_RECONNECT_COOLDOWN_MS: 5000,                // 5 秒
...
// 自动重连 Realtime：仅在确认断开时主动重建 channel（防抖 5 秒）
...
function setupVisibilityListener() { document.addEventListener('visibilitychange', function() { if (document.visibilityState === 'visible') { silentTokenRefresh(); _autoReconnectRealtime(); _autoRefreshDataIfStale(); } }); }
